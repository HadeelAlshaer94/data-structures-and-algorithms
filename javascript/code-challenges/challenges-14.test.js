...
const screenForNames = (arr) => {
  // Solution code here...
  let nameContain = /^(Mr\.|Mrs\.|Ms\.|Dr\.).\w*$/;
  return arr.filter((index) => index.match(nameContain));
}
...
const detectTicTacToeWin = (board) => {
  // Solution code here...
  let firstElement = board[0];
  let secondElement = board[1];
  let thirdElement = board[2];
  for (let i = 0; i < board.length; i++) {
    if (firstElement[0] == secondElement[0] == thirdElement[0] || firstElement[0] == secondElement[1] == thirdElement[2] || firstElement[2] == secondElement[1] == thirdElement[0] || firstElement[0] == firstElement[1] == firstElement[2] || secondElement[0] == secondElement[1] == secondElement[2] || thirdElement[0] == thirdElement[1] == thirdElement[2] || firstElement[1] == secondElement[1] == thirdElement[1] || firstElement[2] == secondElement[2] == thirdElement[2]) {
      return true
    } else {
      return false
    }
