...
const toLastNames = people => {
  // Solution code here...
  let personArr = [];
  people.map(value => { personArr.push(value.firstName + ' ' + value.lastName); })
  return personArr;
};
...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((accumulator, addedValue) => { return accumulator += addedValue }, 0)
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((accumulatorPurchases, purchasesValue) => { return accumulatorPurchases = accumulatorPurchases + purchasesValue.purchasePrice; }, 0)
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce((elementValue) => { return ++elementValue; }, 0)
};
...
const returnNames = (arr) => {
  // Solution code here...
  const namesArray = arr.reduce((accumulatorNames, NamesValue) => {
    accumulatorNames.push(NamesValue.name);
...
const reversedString = (str) => {
  ...
  let genaratedArr = strArr.reduce((reversedAcc, reversedVal) => {
    return reversedVal + reversedAcc;
  }, '');
  return genaratedArr;
};
